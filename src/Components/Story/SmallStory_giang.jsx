...
const SmallStory_giang = ({storyImg, time}) => {
  return (
    <div
    ...
    >
      ...
      <button className="absolute top-3 right-3 z-10 text-xs font-bold text-[--color-violet] bg-white px-2 py-0.5 rounded-[20px] shadow-md hover:shadow-lg hover:bg-gray-100 transition-all duration-200">
        Xóa tin
      </button>
